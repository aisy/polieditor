...
<div id="konten">
			<div class="per-dua code-html">
				<form method="post" action="<?php echo base_url('libraries/eksekusi.php') ?>" target="output">
			...
			</div><div class="per-dua code-preview"><iframe name="output" src="<?php echo base_url('libraries/eksekusi.php') ?>"></iframe></div>			
		</div>
